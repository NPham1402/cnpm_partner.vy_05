...
export default function PartnerRegister() {
  ...
  function RegisterToDatabase() {
    axios
      .post(
        "https://gxyvy04g01backend-production.up.railway.app/Partner/Register",
        {
  ...
  function HandlePage1() {
    ...
    axios
      .post(
        "https://gxyvy04g01backend-production.up.railway.app/Partner/checkEmail",
        {
          PARTNER_EMAIL: getEmail,
        }
      )
  ...
  return (
    <>
      ...
      {getPageId === 2 ? (
        <Step2
          onPage={setPageId}
          getLastName={getPartnerName}
          onLastName={setPartnerName}
        />
      ) : null}
      {getPageId === 3 ? (
        <Step3
          onPage={setPageId}
          functionHandle={HandlePage3}
      ...
      {getPageId === 4 ? (
        <Step4 onPage={setPageId} registerToDataBase={RegisterToDatabase} />
      ) : null}
    </>
  );
}
